...
namespace MainApp.UI.Common.Views
{
	...
	public partial class PickerCell : ViewCell
	{
		...
		public static readonly BindableProperty SelectedValueProperty = BindableProperty.Create<PickerCell, string>
			(cell => cell.SelectedValue, null, BindingMode.TwoWay, null,propertyChanged: (sender, oldValue, newValue) =>
			{
